...
check.addEventListener('change',function(){
  ...
  if(this.checked == true){
    box.setAttribute('style','background-color:#222222;')
  ...
  if(this.checked == false){
    box.setAttribute('style','background-color:#222222; color:white;')
    ball.setAttribute('style','transform:translatex(0%);')
    body.setAttribute('style','background-color:white; color:#222222;')
